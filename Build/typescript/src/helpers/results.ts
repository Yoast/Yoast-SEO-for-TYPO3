...
function isNestedAnalysisResult(
  obj: YoastAnalysisResult | Record<string, YoastAnalysisResult>
): obj is Record<string, YoastAnalysisResult> {
...
export function getScoreFromResult(
  analysis: YoastAnalysis,
  resultType: string,
  resultSubtype: string | null
): string {
