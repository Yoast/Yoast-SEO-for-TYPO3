...
const FleschReadingScore = ({score, difficulty, unsupportedLanguage}) => {
    ...
    if (score) {
        const description = useMemo(() => {
            return getDescriptionElement(score, difficulty, 'https://yoa.st/34s');
        })
...
export default FleschReadingScore;