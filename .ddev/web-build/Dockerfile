...
ENV EXTENSION_KEY "yoast_seo"
ENV DDEV_SITENAME "yoast-seo"
...
RUN echo "<li><h2>TYPO3 11.0</h2><a href="https://v11.${DDEV_SITENAME}.ddev.site/">Frontend</a> | <a href="https://v11.${DDEV_SITENAME}.ddev.site/typo3/">Backend</a></li>" >> /var/www/html/index.html
